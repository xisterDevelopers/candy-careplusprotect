...
if( function_exists('acf_add_options_page') ) {
    ...
    acf_add_options_sub_page("Properties"); 
}
...
function wp_bootstrap_starter_scripts() {
    ...
    //animate.css
    wp_enqueue_style( 'animate', get_template_directory_uri() . '/inc/assets/css/animate.css' );
	// load bootstrap css
	// load AItheme styles
    ...
    wp_enqueue_script('wp-bootstrap-starter-jquery', get_template_directory_uri() . '/inc/assets/js/jquery.min.js', array(), '', true );
    wp_enqueue_script('owlcarousel-scripts', get_template_directory_uri() . '/inc/assets/js/owl.carousel.min.js', array(), '', true );
    wp_enqueue_script('wow-scripts', get_template_directory_uri() . '/inc/assets/js/wow.min.js', array(), '', true );
    wp_enqueue_script('wp-bootstrap-starter-scripts', get_template_directory_uri() . '/inc/assets/js/scripts.js', array(), '', true );
    wp_enqueue_script('wp-bootstrap-datatables', get_template_directory_uri() . '/inc/assets/js/datatables.min.js', array(), '', true );
...
function getSiteSlug() {
    ...
    $obj = get_blog_details($idBlog);
    return str_replace('/', '', $obj->path);
} 
